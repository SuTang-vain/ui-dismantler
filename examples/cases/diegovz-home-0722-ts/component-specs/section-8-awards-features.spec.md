# AwardsFeatures Specification

## Overview
- **Target file:** `src/components/AwardsFeatures.ts`
- **Source selector:** `div.elementor-element-f74185b`
- **Source instances:** 1
- **Interaction model:** click-driven
- **Responsibility:** 复现 content-section 视图：Awards & features
- **Parent:** root
- **Dependencies:** None

## DOM Structure
- Preserve the source subtree rooted at `div.elementor-element-f74185b`.
...
## States & Behaviors
- click: div.elementor-element-6816a38 > div:nth-child(1) > p:nth-child(1) > a:nth-child(1)

## Per-State Content
- Covers: `click|div.elementor-element-6816a38 > div:nth-child(1) > p:nth-child(1) > a:nth-child(1)|semantic-control`

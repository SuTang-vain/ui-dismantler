...
## Overview
- **Target file:** `src/components/Experience.ts`
- **Source selector:** `div.elementor-element-090fbce`
- **Source instances:** 1
- **Interaction model:** static
- **Responsibility:** 复现 content-section 视图：Experience
- **Parent:** root
- **Dependencies:** None

## DOM Structure
- Preserve the source subtree rooted at `div.elementor-element-090fbce`.

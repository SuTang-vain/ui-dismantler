# FragmentsOfMe Specification

## Overview
- **Target file:** `src/components/FragmentsOfMe.ts`
- **Source selector:** `div.elementor-element-74d565c`
- **Source instances:** 1
- **Interaction model:** static
- **Responsibility:** 复现 content-section 视图：Fragments of me
- **Parent:** root
- **Dependencies:** None

## DOM Structure
- Preserve the source subtree rooted at `div.elementor-element-74d565c`.

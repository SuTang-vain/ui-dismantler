# FragmentsOfMeInteractiveShell Specification

## Overview
- **Target file:** `src/components/FragmentsOfMeInteractiveShell.ts`
- **Source selector:** `div.my-story-bento`
- **Source instances:** 1
- **Interaction model:** static
- **Responsibility:** 复现 component-shell 视图：$1 billion raised From Sequoia Capital. Rappi reaches 100M+ downloads Mass adoption across LATAM. Tu
- **Parent:** `section-4-fragments-of-me`
- **Dependencies:** `section-4-fragments-of-me`

## DOM Structure
- Preserve the source subtree rooted at `div.my-story-bento`.
...
- $1 billion raised From Sequoia Capital. Rappi reaches 100M+ downloads Mass adoption across LATAM. Turbo delivery launch 10–15 min deliveries. 30M+ monthly activ

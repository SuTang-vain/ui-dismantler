...
- **Source selector:** `div.elementor-5114`
- **Source instances:** 1
- **Interaction model:** click-driven
- **Responsibility:** 复现 page-header 视图：Based in Madrid, Spain 10:27 GMT+1 · 28ºC
- **Parent:** root
- **Dependencies:** None

## DOM Structure
- Preserve the source subtree rooted at `div.elementor-5114`.
...
## States & Behaviors
- click: div.elementor-element-f1f46c6 > div:nth-child(1) > a:nth-child(1)

## Per-State Content
- Covers: `click|div.elementor-element-f1f46c6 > div:nth-child(1) > a:nth-child(1)|semantic-control`

## Assets & Data
None

## Text Content (verbatim)
- Based in Madrid, Spain 10:27 GMT+1 · 28ºC

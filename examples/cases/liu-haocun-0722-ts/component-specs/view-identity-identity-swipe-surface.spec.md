# IdentitySwipeSurface Specification

## Overview
- **Target file:** `src/components/IdentitySwipeSurface.ts`
- **Source selector:** `#photoCard:where(*)`
- **Source instances:** 1
- **Interaction model:** static
- **Responsibility:** 复现 gesture-surface 视图的结构、样式与状态
- **Parent:** `view-identity-identity-gallery`
- **Dependencies:** `view-identity-identity-gallery`

## DOM Structure
- Preserve the source subtree rooted at `#photoCard:where(*)`.
...
## Per-State Content
- Covers: `pointerdown|#photoCard|script-assignment`
- Covers: `pointerup|#photoCard|script-assignment`

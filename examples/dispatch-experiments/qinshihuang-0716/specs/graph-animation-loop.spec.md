# GraphAnimationLoop Specification

## Overview
- **Target file:** `src/components/GraphAnimationLoop.ts`
- **Source selector:** `svg.family:not(:root)`
- **Source instances:** 1
- **Interaction model:** static
- **Responsibility:** 管理 requestAnimationFrame 同步循环及其启动、停止和销毁
- **Parent:** `edge-renderer`
- **Dependencies:** `edge-renderer`

## DOM Structure
- Preserve the source subtree rooted at `svg.family:not(:root)`.

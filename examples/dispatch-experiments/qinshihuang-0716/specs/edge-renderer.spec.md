# EdgeRenderer Specification

## Overview
- **Target file:** `src/components/EdgeRenderer.ts`
- **Source selector:** `svg.family:where(*)`
- **Source instances:** 1
- **Interaction model:** static
- **Responsibility:** 创建 SVG 边与标签元素，并根据节点端点更新路径几何
- **Parent:** `relationship-canvas`
- **Dependencies:** `relationship-canvas`

## DOM Structure
- Preserve the source subtree rooted at `svg.family:where(*)`.

...
function sample(round: number, totalMs: number, stabilityFailures = 0, passed = true): BenchmarkSample {
  return {
    ...
    timing: { analyzeMs: 1, validateMs: 2, roundtripMs: 3, visualMatrixMs: 4, scenarioStateMs: 5, scenarioVisualMatrixMs: 6, totalMs },
    browserTiming: { launchMs: 1, contextCreateMs: 1, contextInitMs: 1, pageCreateMs: 1, navigationMs: 2, settleMs: 3, domStabilityMs: 4, networkIdleMs: 5, fixedWaitMs: 0, fontPreflightMs: 0, timerGraceMs: 0, resourceScanMs: 1, signatureScanMs: 1, scenarioExecutionMs: 1, scrollAnchorMs: 0, snapshotEvaluationMs: 1, screenshotMs: 1, pixelDiffMs: 1, artifactWriteMs: 1, closeMs: 1, totalMs: totalMs - 1 },
    workload: { interactions: 2, formalScenarios: 1, criticalScenarios: 1, coverageWaivers: 0, viewports: 4, scenarioViewportRuns: 4 },

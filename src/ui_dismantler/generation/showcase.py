"""High-density design-system showcase generator.

Extracts design tokens, responsive breakpoints, component classes and interaction
states from a generated component library, then renders a self-contained Bento
showcase. CLI handling lives in ``ui_dismantler.cli.generate_showcase``.
"""

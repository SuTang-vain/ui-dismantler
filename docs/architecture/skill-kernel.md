...
- `production.ts` composes reviewed Primitive DOM, owner-scoped state, Data Surface, runtime inputs, materialization, smoke, validation, and quality into one deterministic production operation without becoming a Skill.
